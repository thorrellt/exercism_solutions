...
export class TranslationService {
  ...
  free(text) {
     return this.api.fetch(text)
      .then (retValue => {
        console.log('retValue: ' + retValue.translation);
        return retValue.translation;
      })
      .catch(err => {
        throw err;
      });
  ...
  request(text) {
    const api = this.api;
    function requestAsPromise(textToReq) {
      return new Promise((resolve, reject) => {
        api.request(textToReq, (err) => (err ? reject(err) : resolve()));
      })
    }
